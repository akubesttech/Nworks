    ...
    <div class="col-xs-12">
        <div id="breadcrumbs-share">
            <section id="breadcrumbs">
                <ul class="breadcrumb">
                                <li><a href="../">Home</a> </li>
                                <li><a href="/?view=About">About CMSystem</a> </li>
        ...
        <div class="col-xs-12 col-md-9 margin-lg-bottom link-icons">
            <div class="row">
                <div class="col-xs-12 primary-content link-icons">
                    <p class="first-paragraph">Follow the 5 steps below to apply to one or more institutions.</p>
            ...
            <div class="col-xs-12 col-md-7">
                <ul class="link-list step-list">
                            ...
                            <li>
                                <a href="#step1">1. Find your desired institution</a>
                            </li>
                            <li>
                                <a href="#step2">2. Click on Apply for Admission</a>
                            </li>
                            <li>
                                <a href="#step3">3. Complete the first step and Proceed to pay your Application Fee</a>
                            </li>
                            <li>
                                <a href="#step4">4. Once your application fees payment is successful, complete your application using your assigned serial number and pin generated from your payment.</a>
                            </li>
                            <li>
                                <a href="#step5">5. Complete Application at Institution of Choice</a>
                            </li>
                </ul>
            </div>
...
<p>You will need to find your desired institution of your choice before applying for admission. You can click on <a  href="#" onclick="window.open('?view=Our_institutions','_self')"> <strong>Institutions</strong></a> to view the various institutions in Delta State before applying.</p>
                </div>
                <div class="col-xs-12">
                    <a name="step2"></a>
