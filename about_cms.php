...
CMSystem is an online application portal that allows prospective/existing students and faculties access various educational services such as Admissions, Elearning, E-Library, Psychometric Assessments etc in any of the tertiary institutions in Delta State. 
institutions.</p>
                </div>
                        <div class="col-xs-12">
        ...
        <div class="margin-md-top row cards section-cards">
            <div class="col-xs-12">
                <div class="row nopadding nomargin" id="cards">
						<div class="col-xs-12 col-md-4 card card-half" onclick="window.open('/?view=Before_You_Start','_self')">
							<div class="card-content" style="background-image: url(./assets/media/apply-now2.jpg?anchor=center&amp;mode=crop&amp;width=800&amp;height=450&amp;rnd=131329381090000000);">
								<div class="col-sm-12 card-overlay">
									<div class="title">
										<a href="/?view=Before_You_Start"><span class="name">Before You Start</span></a>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-4 card card-half" onclick="window.open('/?view=Application_Process','_self')">
							<div class="card-content" style="background-image: url(./assets/media/application-process2.jpg?anchor=center&amp;mode=crop&amp;width=800&amp;height=450&amp;rnd=131190566240000000);">
								<div class="col-sm-12 card-overlay">
									<div class="title">
										<a href="/?view=Application_Process"><span class="name">Application Process</span></a>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-4 card card-half" onclick="/?view=Our_institutions','_self')">
							<div class="card-content" style="background-image: url(./assets/media/participating-institutions2.jpg?anchor=center&amp;mode=crop&amp;width=800&amp;height=450&amp;rnd=131193646260000000);">
								<div class="col-sm-12 card-overlay">
									<div class="title">
										<a href="/?view=Our_institutions"><span class="name">Institutions</span></a>
									</div>
								</div>
							</div>
						</div>
